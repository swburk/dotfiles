...
if has("spell")
    call s:HL('SpellCap', '', 'bg', 'undercurl', 'dalespale')
    call s:HL('SpellBad', '', 'bg', 'undercurl', 'taffy')
    call s:HL('SpellLocal', '', 'bg', 'undercurl', 'tardis')
    call s:HL('SpellRare', '', 'bg', 'undercurl', 'tardis')
endif
